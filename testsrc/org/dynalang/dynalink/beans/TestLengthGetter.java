...
public class TestLengthGetter extends TestCase {
    ...
    private static GuardedInvocation getGuardedInvocation(
        ...
        return linker.getGuardedInvocation(
                new LinkRequestImpl(descriptor, args), null);
    }

    private void testEarlyBoundArrayLengthGetter(Class<?> arrayClass)
            throws Throwable {
    ...
    public void testEarlyBoundCollectionLengthGetter() throws Throwable {
        ...
        assertEquals(csd.getMethodType(), mh.type());
        assertEquals(0, mh
                .invokeWithArguments(new Object[] { Collections.EMPTY_LIST }));
        assertEquals(2, mh.invokeWithArguments(new Object[] { Arrays
                .asList(new Object[] { "a", "b" }) }));
    }
    ...
    public void testEarlyBoundMapLengthGetter() throws Throwable {
        ...
        assertEquals(1, mh.invokeWithArguments(Collections.singletonMap("a",
                "b")));
    }
    ...
    public void testLateBoundLengthGetter() throws Throwable {
        ...
        final RelinkCountingCallSite callSite =
                new RelinkCountingCallSite("dyn:getLength", MethodType
        ...
        assertEquals(3, callSiteInvoker
                .invokeWithArguments(new Object[] { new Object[3] }));
        ...
        assertEquals(5, callSiteInvoker
                .invokeWithArguments(new Object[] { Arrays
                        .asList(new Object[5]) }));
        // Relinked for collections
        assertEquals(2, callSite.getRelinkCount());
        assertEquals(0, callSiteInvoker
                .invokeWithArguments(new HashSet<Object>()));
        // No relink for various collection types
        assertEquals(2, callSite.getRelinkCount());

        assertEquals(1, callSiteInvoker.invokeWithArguments(Collections
                .singletonMap("1", "2")));
        // Relinked for maps
        assertEquals(3, callSite.getRelinkCount());
        assertEquals(0, callSiteInvoker
                .invokeWithArguments(new HashMap<Object, Object>()));
