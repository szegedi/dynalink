...
/**
 * Used as a factory for call site descriptor implementations. You shouldn't use this class directly but rather use
    ...
    public static CallSiteDescriptor create(Lookup lookup, String name, MethodType methodType, Object... bootstrapArgs) {
        ...
        if(bootstrapArgs == null || bootstrapArgs.length == 0) {
            ...
            if(isPublicLookup(lookup)) {
                ...
                return new LookupArgsCallSiteDescriptor(tokenizedName, methodType, lookup, clonedArgs);
            }
        }
    }
