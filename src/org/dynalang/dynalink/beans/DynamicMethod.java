 ...
 * single Java method, or can be bound to all overloaded methods of the same
 * name on a class. Getting an invocation of a dynamic method bound to multiple
 * overloaded methods will perform overload resolution (actually, it will
 * perform partial overloaded resolution at link time, but if that fails to
