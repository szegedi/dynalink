...
public interface LinkRequest {
     ...
     * runtime-specific context parameters in their call sites as the first
     * few arguments. If a linker does not recognize such contexts at all, or
     * does not recognize the call site as one with its own context, it can ask
     * for the alternative link request with context parameters and arguments
